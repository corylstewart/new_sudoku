...
class YahooQuery:
    ...
    #query yahoo for the stocks entire option chain
    '''def option_chain(self,stock_symbol, expiration = ''):
        stock = sr.StockRetriever()
        option_chain = stock.get_options_info(stock_symbol, expiration = expiration)
        return option_chain'''
